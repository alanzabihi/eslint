...
module.exports = class TokenStore {
	...
	constructor(tokens, comments) {
		...
		/*
		 * Lazy index map: starts with binary search, builds hash map after threshold.
		 * Uses closure variables so Object.freeze(this) does not block mutation.
		 */
		let lookups = 0;
		let indexMap = null;

		this.getIndexMap = function () {
			if (indexMap === null && ++lookups === 200) {
				indexMap = createIndexMap(tokens, comments);
			}
			return indexMap;
		};
	}
