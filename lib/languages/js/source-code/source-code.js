...
class SourceCode extends TokenStore {
	...
	traverse() {
		...
		/*
		 * Inline recursive walk — eliminates Traverser class overhead:
		 * no isNode() per child, no _skipped/_broken checks, no _parents
		 * tracking, no _current state, no getVisitorKeys wrapper.
		 */
		const visitorKeys = this.visitorKeys;

		/**
		 * @param {ASTNode} node The node to walk.
