...
class SourceCode extends TokenStore {
	...
	/**
	 * Whether parent properties have been assigned to AST nodes.
	 * @type {boolean}
	 */
	...
	/**
	 * Assigns parent properties to all AST nodes. This is a lightweight
	 * walk that does not build step objects or run code path analysis.
	 * @returns {void}
	 */
	assignParentProperties() {
		if (this.#parentsAssigned) {
			return;
		}
	...
	/**
	 * Traverse the source code and dispatch events inline without
	 * building an intermediate step array.
	 * @param {Object} handler Handler with onVisitEnter, onVisitLeave, onCallMethod methods.
	 * @returns {void}
	 */
	traverseInline(handler) {
		const needsParents = !this.#parentsAssigned;
