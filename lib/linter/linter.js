...
function runRules(
	...
	/*
	 * Assign parent properties before rule setup so rules can
	 * access them during create(). This is a lightweight walk
	 * that does not build step objects or run code path analysis.
	 */
	if (typeof sourceCode.assignParentProperties === "function") {
		sourceCode.assignParentProperties();
	}
